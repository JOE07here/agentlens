...
<title>${BRAND.name} Report — ${esc(formatDate(scan.scannedAt))}</title></head>
...
<div style="max-width:900px;margin:0 auto;padding:28px 20px 64px">
  <h1 style="font-size:26px;margin:0 0 4px">${BRAND.name} — Risk Report</h1>
  ...
  <p style="margin-top:32px;color:#7A8194;font-size:12px">Generated by ${BRAND.name} — all analysis ran locally in the browser. Nothing left the device.</p>
</div></body></html>`;
}
